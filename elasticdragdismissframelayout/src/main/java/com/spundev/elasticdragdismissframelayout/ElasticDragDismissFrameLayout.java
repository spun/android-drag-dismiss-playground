package com.spundev.elasticdragdismissframelayout;
...
import com.spundev.elasticdragdismissframelayout.util.AnimUtils;
import com.spundev.elasticdragdismissframelayout.util.ColorUtils;
import com.spundev.elasticdragdismissframelayout.util.ViewUtils;

import java.util.ArrayList;
import java.util.List;

/**
 * A {@link FrameLayout} which responds to nested scrolls to create drag-to-dismiss layouts.
...
public class ElasticDragDismissFrameLayout extends FrameLayout {
    ...
    private ElasticDragDismissFrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
